...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="w-8 h-8 flex items-center justify-center rounded-lg border border-stone-200 dark:border-white/8 bg-white dark:bg-white/5 hover:bg-stone-50 dark:hover:bg-white/10 transition-colors"
