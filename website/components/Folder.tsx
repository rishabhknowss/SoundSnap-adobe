...
const Folder = ({ color = '#5227FF', size = 1, items = [], className = '', autoOpen = false, autoInterval = 3000 }: FolderProps) => {
  const maxItems = 3;
  ...
  const folderClassName = `folder ${open ? 'open' : ''} ${autoOpen ? 'auto-peek' : ''}`.trim();
